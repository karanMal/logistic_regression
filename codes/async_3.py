...
workers=["10.1.1.253:2223","10.1.1.252:2224","10.1.1.251:2221"];
...
#         tf.summary.scalar("Accuracy", accuracy(test_prediction,label_test))
    ...
    #         data_train = data_train[shuffled_indexes];
            ...
            if FLAGS.task_index==0:
                ...
                cost_plot_task2.append(train_cost);
    ...
    np.save(log_dir+'worker2.npy',cost_plot_task2);
